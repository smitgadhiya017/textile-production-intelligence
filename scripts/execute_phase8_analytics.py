...
def run_phase8_analytics():
    print("===============================================================================")
    print("PHASE 8: EXECUTING & VALIDATING INTERMEDIATE SQL ANALYTICS (20 QUERIES)")
    print("===============================================================================")
    ...
    # Read queries from database/08_intermediate_analytics.sql
    with open("database/08_intermediate_analytics.sql", "r", encoding="utf-8") as f:
    ...
    for header, sql_stmt in query_blocks:
        ...
        try:
            ...
            print(f"QUERY {query_count + 20:02d}: {q_title}")
            ...
            print(f"QUERY {query_count + 20:02d}: {q_title} - FAILED: {e}")
            conn.close()
            return False
    ...
    if query_count >= 20:
        print("===============================================================================")
        print("ALL 20 INTERMEDIATE SQL ANALYTICS QUERIES EXECUTED AND VALIDATED SUCCESSFULLY!")
        print("===============================================================================")
        return True
    return False

if __name__ == "__main__":
    if run_phase8_analytics():
        sys.exit(0)
    else:
        sys.exit(1)
